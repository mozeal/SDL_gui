...
/* Harfbuzz */
extern DECLSPEC void SDLCALL TTF_SetDirection(int direction); /* hb_direction_t */
extern DECLSPEC void SDLCALL TTF_SetScript(int script); /* hb_script_t */
...
/* Tooh - Fix Harfbuzz in release mode */
extern DECLSPEC void TTF_hb_buffer_set_direction(hb_buffer_t *buffer, hb_direction_t direction);
extern DECLSPEC void TTF_hb_buffer_set_script(hb_buffer_t *buffer, hb_script_t script);
extern DECLSPEC void TTF_hb_buffer_add_utf8(hb_buffer_t *buffer, const char *text, int text_length, unsigned int item_offset, int item_length);
extern DECLSPEC void TTF_hb_shape(hb_font_t *font, hb_buffer_t *buffer, const hb_feature_t *features, unsigned int num_features);
extern DECLSPEC void TTF_hb_font_destroy(hb_font_t *font);
extern DECLSPEC hb_glyph_info_t* TTF_hb_buffer_get_glyph_infos(hb_buffer_t *buffer, unsigned int *length);
extern DECLSPEC hb_glyph_position_t* TTF_hb_buffer_get_glyph_positions(hb_buffer_t *buffer, unsigned int *length);
extern DECLSPEC hb_buffer_t* TTF_hb_buffer_create(void);
extern DECLSPEC void TTF_hb_buffer_destroy(hb_buffer_t *buffer);
