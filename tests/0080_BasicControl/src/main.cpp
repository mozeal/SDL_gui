...
int main(int argc, char *argv[]) {
    ...
    auto column3= GUI_View::create(topView, "COL2", 0, 0, -1, -1);
    column3->setLayout(GUI_LAYOUT_VERTICAL);
    column3->setMargin( 0, 0, 0, 10 );
    column3->setBorder( 1 );
    column3->setCorner( 4 );
    column3->setPadding( 10, 10, 10, 10 );
    

    auto lableC3_1 = GUI_Label::create( column3, "Please enter text:", 0, 0, -1, 0 );
    
    auto edit1 = GUI_EditText::create( column3, "", 0, 0, -1, 0, [=](GUI_View *v) {
