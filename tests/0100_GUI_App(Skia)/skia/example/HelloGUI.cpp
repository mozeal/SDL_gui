...
void createColumn2(GUI_View *subContentView) {
    ...
    auto img = GUI_ImageView::create(column2, "Icon", "images/logo.png", 0, 0, -1, -1 );
...
void createFindMessageBox(std::string msg) {
...
int main(int argc, char** argv) {
    ...
    app = GUI_App::create("Hello GUI", expectedWidth, expectedHeight, GUI_ORIENTATION_LANDSCAPE,
