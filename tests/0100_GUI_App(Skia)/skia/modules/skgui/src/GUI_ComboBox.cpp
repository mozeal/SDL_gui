...
//    TTF_Font *font = GUI_Fonts::getFont(GUI_GetUITextFontName(), GUI_GetUITextFontSize());
//    int hf = (TTF_FontHeight(font)/GUI_scale) + 16;
//    int hf=16;
    SkFont font = GUI_Fonts::getFont(GUI_GetUITextFontName(), GUI_GetUITextFontSize());
    int hf = (font.getSize()/GUI_scale) + 16;
